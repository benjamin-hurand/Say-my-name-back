...
public class FactDao {
    ...
    private final FactRepository personAttributeRepository;
    private final FactEntityMapper personAttributeEntityMapper;
    private final AttributeRepository attributeRepository;
    private final PersonRepository personRepository;

    public FactDao(FactRepository personAttributeRepository,
    ...
    public List<Fact> findFactsByPersonId(Long personId) {
