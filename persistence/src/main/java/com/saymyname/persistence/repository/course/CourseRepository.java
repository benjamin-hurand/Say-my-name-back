...
public interface CourseRepository extends JpaRepository<CourseEntity, Long> {
    ...
    List<CourseEntity> findByUserIdAndStatusInOrderByLastAccessedAtDesc(Long userId, Collection<CourseStatus> statuses);
    ...
    @Modifying
    @Query("UPDATE CourseEntity c SET c.lastAccessedAt = :at WHERE c.id = :courseId")
