...
public interface LeaderboardStatRepository extends JpaRepository<LeaderboardStatEntity, Long> {
  ...
  @Query(value = """
          ...
          WHERE ls.tenant_id = :#{T(com.saymyname.core.multitenancy.TenantContext).get()}
  ...
  @Query(value = """
          ...
          JOIN leaderboard_stats me
           ...
           AND me.tenant_id = :#{T(com.saymyname.core.multitenancy.TenantContext).get()}
          WHERE other.tenant_id = :#{T(com.saymyname.core.multitenancy.TenantContext).get()}
            AND (
                  other.xp > me.xp
