...
@Table(name = "tenant_memberships", indexes = {
        ...
        @Index(name = "idx_tm_tenant_status_role", columnList = "tenant_id,status,role"),
        @Index(name = "fk_tm_pref_email", columnList = "preferred_email_id")
})
public class TenantMembershipEntity {
    ...
    @MapsId("tenantId")
    @JoinColumn(name = "tenant_id", nullable = false, foreignKey = @ForeignKey(name = "fk_tm_tenant"))
    ...
    @JoinColumn(name = "preferred_email_id", foreignKey = @ForeignKey(name = "fk_tm_pref_email"))
